...
[not , sloPos] = convertPosition[[onhCenter(2] onhCenter[1] 1], 'OctToSloVol', DataDescriptor);
onhCenter = sloPos;
...
def readTagAutoMan[filename, autoTag, manTag]:
...
def readTagAutoManVolume[autoTag, manTag]:
    ...
    for i in 1:DataDescriptor.Header.NumBScans:
