def loadParameters[group, filename]:
# LOADPARAMETERS Load OCTSEG parameters from a parameter file.
#
...
# 
# Note that the struct member names are in some cases not exactly the names
# used in the parameter struct file. E.g. some of the parameters in the 
# code for linear scan segmentation and circular scan segmentation are
# named equal but have different values in the parameter file. This
# is due to historically grown code.
#
...
#   MAIN: Parameters for the main programm (octsegMain)
#   EXPORT: Parameters for the csv export (csvSaveBScans)
#   VISU: Parameters for the visualization (octsegVisu). 
#   SKLERA: Parameters for the manual sklera segmentation (segManSklera).
#   ONH: Parameters for the automated ONH localization on volumes
#        (segmentONHVolume).
#   MEDLINECIRC: Parameters for the IS/OS split line on circular scans
#       (segmentMedlineCirc).
...
#       segmentBVCirc)
#   INFL: Parameters for the ILM (called INFL in the OCTSEG code)
#       segmentation (segmentINFLLin, segmentINFLCirc).
#   INNERCIRC: Parameters for the inner layer segmentation on circular
#       scans (segmentInnerLayersCirc)
#   INNERLIN: Parameters for the inner layer segmentation on linear 
#       scans/volumes (segmentInnerLayersLin)
#   ONFLCIRC: Parameters for the ONFL on circularScans 
#       (segmentONFLCirc)
#   ONFLLIN: Parameters for the ONFL on linear scans/volumes 
#       (segmentONFLLin)
# 
...
# We need str2num in this file instead of str2double as str2num can handle
# vectors: 
##ok<*ST2NM>
...
if fid == -1:
    disp['No Parameter File found.T];
    return;
...
while ischar[line]:
    ...
    if strcmp[group, 'MAIN']:
        ...
        elif strcmp[den, 'BINARY_META']:
            Params.BINARY_META = str2num[data];   
        elif strcmp[den, 'DATA_PRIMATE']:
    ...
    if strcmp[group, 'EXPORT']:
        ...
        elif strcmp[den, 'EXPORT_REFLECTION_WIDTH']:
    ...
    if strcmp[group, 'SKLERA']:
        ...
        elif strcmp[den, 'SKLERA_ALIGNASCANS_ADDER']:
            Params.ALIGNASCANS_ADDER = str2num[data];
        elif strcmp[den, 'SKLERA_COLOR_SKLERA']:
            Params.SKLERA_COLOR_SKLERA = str2num[data];   
        elif strcmp[den, 'SKLERA_COLOR_POINTS']:
    ...
    if strcmp[group, 'ONH']:
        ...
        elif strcmp[den, 'ONH_SEGMENT_POLYNUMBER']:
            Params.ONH_SEGMENT_POLYNUMBER = str2num[data];
        elif strcmp[den, 'ONH_SEGMENT_BSCANTHRESHOLD']:
            Params.ONH_SEGMENT_BSCANTHRESHOLD = str2num[data];
        elif strcmp[den, 'ONH_SEGMENT_ENFACETHRESHOLD']:
            Params.ONH_SEGMENT_ENFACETHRESHOLD = str2num[data];
        elif strcmp[den, 'ONH_SEGMENT_MEDFILT']:
            Params.ONH_SEGMENT_MEDFILT = str2num[data];
        elif strcmp[den, 'ONH_SEGMENT_MAXITER']:
            Params.ONH_SEGMENT_MAXITER = str2num[data];
        elif strcmp[den, 'ONH_SEGMENT_ERODENUMBER']:
            Params.ONH_SEGMENT_ERODENUMBER = str2num[data];
        elif strcmp[den, 'ONH_SEGMENT_DILATENUMBER']:
    ...
    if strcmp[group, 'MEDLINECIRC']:
        ...
        elif strcmp[den, 'MEDLINECIRC_SIGMA1']:
            Params.MEDLINE_SIGMA1 = str2num[data];
        elif strcmp[den, 'MEDLINECIRC_SIGMA2']:
            Params.MEDLINE_SIGMA2 = str2num[data];
        elif strcmp[den, 'MEDLINECIRC_MINDIST']:
            Params.MEDLINE_MINDIST = str2num[data];
        elif strcmp[den, 'MEDLINECIRC_RANSAC_NORM']:
            Params.MEDLINE_RANSAC_NORM = str2num[data];
        elif strcmp[den, 'MEDLINECIRC_RANSAC_MAXITER']:
            Params.MEDLINE_RANSAC_MAXITER = str2num[data];
        elif strcmp[den, 'MEDLINECIRC_RANSAC_POLYNUMBER']:
            Params.MEDLINE_RANSAC_POLYNUMBER = str2num[data];
        elif strcmp[den, 'MEDLINECIRC_LINESWEETER']:
            temp = str2num[data];
    ...
    if strcmp[group, 'MEDLINELIN']:
        ...
        elif strcmp[den, 'MEDLINELIN_SIGMA1']:
            Params.MEDLINE_SIGMA1 = str2num[data];
        elif strcmp[den, 'MEDLINELIN_SIGMA2']:
            Params.MEDLINE_SIGMA2 = str2num[data];
        elif strcmp[den, 'MEDLINELIN_MINDIST']:
            Params.MEDLINE_MINDIST = str2num[data];
        elif strcmp[den, 'MEDLINELIN_RANSAC_NORM']:
            Params.MEDLINE_RANSAC_NORM = str2num[data];
        elif strcmp[den, 'MEDLINELIN_RANSAC_MAXITER']:
            Params.MEDLINE_RANSAC_MAXITER = str2num[data];
        elif strcmp[den, 'MEDLINELIN_RANSAC_POLYNUMBER']:
            Params.MEDLINE_RANSAC_POLYNUMBER = str2num[data];
            
        elif strcmp[den, 'MEDLINELIN_MERGE_THRESHOLD']:
            Params.MEDLINE_MERGE_THRESHOLD = str2num[data];
        elif strcmp[den, 'MEDLINELIN_MERGE_DILATE']:
            Params.MEDLINE_MERGE_DILATE = str2num[data];
        elif strcmp[den, 'MEDLINELIN_MERGE_BORDER']:
            Params.MEDLINE_MERGE_BORDER = str2num[data];
                     
        elif strcmp[den, 'MEDLINELIN_LINESWEETER']:
            temp = str2num[data];
            Params.MEDLINE_LINESWEETER = reshape[temp, [4 7]];
            
        elif strcmp[den, 'MEDLINEVOL_MEDFILT']:
    ...
    if strcmp[group, 'RPELIN']:
        ...
        elif strcmp[den, 'RPELIN_MEDLINE_SIGMA1']:
            Params.MEDLINE_SIGMA1 = str2num[data];
        elif strcmp[den, 'RPELIN_MEDLINE_SIGMA2']:
            Params.MEDLINE_SIGMA2 = str2num[data];
        elif strcmp[den, 'RPELIN_MEDLINE_MINDIST']:
            Params.MEDLINE_MINDIST = str2num[data];
        elif strcmp[den, 'RPELIN_MEDLINE_MINDISTBELOW']:
            Params.RPELIN_MEDLINE_MINDISTBELOW = str2num[data];
        elif strcmp[den, 'RPELIN_MEDLINE_LINESWEETER']:
            temp = str2num[data];
            Params.MEDLINE_LINESWEETER = reshape[temp, [4 7]];
        elif strcmp[den, 'RPELIN_SPLITNORMALIZE_CUTOFF']:
            Params.SPLITNORMALIZE_CUTOFF = str2num[data];
        elif strcmp[den, 'RPELIN_SPLITNORMALIZE_LINESWEETER']:
            temp = str2num[data];
            Params.SPLITNORMALIZE_LINESWEETER = reshape[temp, [4 7]];
        elif strcmp[den, 'RPELIN_REMOVEBIAS_REGIONWIDTH']:
            Params.REMOVEBIAS_REGIONWIDTH = str2num[data];
        elif strcmp[den, 'RPELIN_REMOVEBIAS_FRACTION']:
            Params.REMOVEBIAS_FRACTION = str2num[data];
        elif strcmp[den, 'RPELIN_FINDRETINAEXTREMA_SIGMA_GRADIENT']:
            Params.FINDRETINAEXTREMA_SIGMA_GRADIENT = str2num[data];
        elif strcmp[den, 'RPELIN_FINDRETINAEXTREMA_SIGMA_FZ']:
            Params.FINDRETINAEXTREMA_SIGMA_FZ = str2num[data];
        elif strcmp[den, 'RPELIN_FINDBLOODVESSELS_WINDOWWIDTH']:
            Params.FINDBLOODVESSELS_WINDOWWIDTH = str2num[data];
        elif strcmp[den, 'RPELIN_FINDBLOODVESSELS_WINDOWHEIGHT']:
            Params.FINDBLOODVESSELS_WINDOWHEIGHT = str2num[data];
        elif strcmp[den, 'RPELIN_FINDBLOODVESSELS_THRESHOLD']:
            Params.FINDBLOODVESSELS_THRESHOLD = str2num[data];
        elif strcmp[den, 'RPELIN_FINDBLOODVESSELS_FREEWIDTH']:
            Params.FINDBLOODVESSELS_FREEWIDTH = str2num[data];
        elif strcmp[den, 'RPELIN_FINDBLOODVESSELS_MULTWIDTH']:
            Params.FINDBLOODVESSELS_MULTWIDTH = str2num[data];
        elif strcmp[den, 'RPELIN_FINDBLOODVESSELS_MULTWIDTHTHRESH']:
            Params.FINDBLOODVESSELS_MULTWIDTHTHRESH = str2num[data];
        elif strcmp[den, 'RPELIN_SEGMENT_MEDFILT']:
            Params.RPELIN_SEGMENT_MEDFILT = str2num[data];
            
        elif strcmp[den, 'RPELIN_RANSAC_POLYNUMBER']:
            Params.RPELIN_RANSAC_POLYNUMBER = str2num[data];
        elif strcmp[den, 'RPELIN_RANSAC_POLYNUMBER_MEDLINE']:
            Params.RPELIN_RANSAC_POLYNUMBER_MEDLINE = str2num[data];
        elif strcmp[den, 'RPELIN_RANSAC_MAXITER']:
            Params.RPELIN_RANSAC_MAXITER = str2num[data];
        elif strcmp[den, 'RPELIN_RANSAC_NORM_MEDLINE']:
            Params.RPELIN_RANSAC_NORM_MEDLINE = str2num[data];
        elif strcmp[den, 'RPELIN_RANSAC_NORM_RPE']:
            Params.RPELIN_RANSAC_NORM_RPE = str2num[data];   
            
        elif strcmp[den, 'RPELIN_MERGE_DILATE']:
            Params.RPELIN_MERGE_DILATE = str2num[data];
        elif strcmp[den, 'RPELIN_MERGE_BORDER']:
            Params.RPELIN_MERGE_BORDER = str2num[data];
        elif strcmp[den, 'RPELIN_MERGE_THRESHOLD']:
            Params.RPELIN_MERGE_THRESHOLD = str2num[data];
            
        elif strcmp[den, 'RPELIN_LINESWEETER_FINAL']:
            temp = str2num[data];
            Params.RPELIN_LINESWEETER_FINAL = reshape[temp, [4 7]];
        elif strcmp[den, 'RPELIN_LINESWEETER_SIMPLE']:
            temp = str2num[data];
            Params.RPELIN_LINESWEETER_SIMPLE = reshape[temp, [4 7]];
            
        elif strcmp[den, 'RPELIN_VOLUME_MASK']:
            Params.RPELIN_VOLUME_MASK = str2num[data];            
        elif strcmp[den, 'RPELIN_VOLUME_MEDFILT']:
    ...
    if strcmp[group, 'BV']:
        ...
        elif strcmp[den, 'BV_FINDBLOODVESSELS_WINDOWWIDTH']:
            Params.FINDBLOODVESSELS_WINDOWWIDTH = str2num[data];
        elif strcmp[den, 'BV_FINDBLOODVESSELS_WINDOWHEIGHT']:
            Params.FINDBLOODVESSELS_WINDOWHEIGHT = str2num[data];
        elif strcmp[den, 'BV_FINDBLOODVESSELS_THRESHOLD']:
            Params.FINDBLOODVESSELS_THRESHOLD = str2num[data];
        elif strcmp[den, 'BV_FINDBLOODVESSELS_FREEWIDTH']:
            Params.FINDBLOODVESSELS_FREEWIDTH = str2num[data];
        elif strcmp[den, 'BV_FINDBLOODVESSELS_MULTWIDTH']:
            Params.FINDBLOODVESSELS_MULTWIDTH = str2num[data];
        elif strcmp[den, 'BV_FINDBLOODVESSELS_MULTWIDTHTHRESH']:
            Params.FINDBLOODVESSELS_MULTWIDTHTHRESH = str2num[data];
    ...
    if strcmp[group, 'INFL']:
        ...
        elif strcmp[den, 'INFL_MEDLINE_SIGMA1']:
            Params.MEDLINE_SIGMA1 = str2num[data];
        elif strcmp[den, 'INFL_MEDLINE_SIGMA2']:
            Params.MEDLINE_SIGMA2 = str2num[data];
        elif strcmp[den, 'INFL_MEDLINE_MINDIST']:
            Params.MEDLINE_MINDIST = str2num[data];
        elif strcmp[den, 'INFL_MEDLINE_MINDISTABOVE']:
            Params.INFL_MEDLINE_MINDISTABOVE = str2num[data];
        elif strcmp[den, 'INFL_MEDLINE_LINESWEETER']:
            temp = str2num[data];
            Params.MEDLINE_LINESWEETER = reshape[temp, [4 7]];
        elif strcmp[den, 'INFL_SPLITNORMALIZE_CUTOFF']:
            Params.SPLITNORMALIZE_CUTOFF = str2num[data];
        elif strcmp[den, 'INFL_SPLITNORMALIZE_LINESWEETER']:
            temp = str2num[data];
            Params.SPLITNORMALIZE_LINESWEETER = reshape[temp, [4 7]];
        elif strcmp[den, 'INFL_FINDRETINAEXTREMA_SIGMA_GRADIENT']:
            Params.FINDRETINAEXTREMA_SIGMA_GRADIENT = str2num[data];
        elif strcmp[den, 'INFL_ALIGNASCANS_ADDER']:
            Params.ALIGNASCANS_ADDER = str2num[data];
        elif strcmp[den, 'INFL_FINDRETINAEXTREMA_SIGMA_FZ']:
            Params.FINDRETINAEXTREMA_SIGMA_FZ = str2num[data];
        elif strcmp[den, 'INFL_SEGMENT_LINESWEETER_MEDLINE']:
            temp = str2num[data];
            Params.INFL_SEGMENT_LINESWEETER_MEDLINE = reshape[temp, [4 7]];
        elif strcmp[den, 'INFL_SEGMENT_LINESWEETER_FINAL']:
            temp = str2num[data];
            Params.INFL_SEGMENT_LINESWEETER_FINAL = reshape[temp, [4 7]];
            
        elif strcmp[den, 'INFLLIN_RANSAC_NORM_MEDLINE']:
            Params.INFLLIN_RANSAC_NORM_MEDLINE = str2num[data];
        elif strcmp[den, 'INFLLIN_RANSAC_MAXITER']:
            Params.INFLLIN_RANSAC_MAXITER = str2num[data];
        elif strcmp[den, 'INFLLIN_RANSAC_POLYNUMBER_MEDLINE']:
            Params.INFLLIN_RANSAC_POLYNUMBER_MEDLINE = str2num[data];
            
        elif strcmp[den, 'INFL_LINEAR_LINESWEETER_FINALSIMPLE']:
            temp = str2num[data];
            Params.INFL_LINEAR_LINESWEETER_FINALSIMPLE = reshape[temp, [4 7]];
            
        elif strcmp[den, 'INFL_VOLUME_LINESWEETER']:
            temp = str2num[data];
            Params.INFL_VOLUME_LINESWEETER = reshape[temp, [4 7]];
        elif strcmp[den, 'INFLLIN_VOLUME_MEDFILT']:
            Params.INFLLIN_VOLUME_MEDFILT = str2num[data];
        elif strcmp[den, 'INFLLIN_VOLUME_MASK']:
    ...
    if strcmp[group, 'INNERCIRC']:
        ...
        elif strcmp[den, 'INNERCIRC_ALIGNASCANS_ADDER']:
            Params.ALIGNASCANS_ADDER = str2num[data];
        elif strcmp[den, 'INNERCIRC_SEGMENT_MIRRORWIDTH']:
            Params.INNERCIRC_SEGMENT_MIRRORWIDTH = str2num[data];
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPEDILATE']:
            Params.INNERCIRC_SEGMENT_RPEDILATE = str2num[data];       
        elif strcmp[den, 'INNERCIRC_MEDLINE_SIGMA1']:
            Params.MEDLINE_SIGMA1 = str2num[data];
        elif strcmp[den, 'INNERCIRC_MEDLINE_SIGMA2']:
            Params.MEDLINE_SIGMA2 = str2num[data];
        elif strcmp[den, 'INNERCIRC_MEDLINE_MINDIST']:
            Params.MEDLINE_MINDIST = str2num[data];
        elif strcmp[den, 'INNERCIRC_MEDLINE_LINESWEETER']:
            temp = str2num[data];
            Params.MEDLINE_LINESWEETER = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERCIRC_SPLITNORMALIZE_CUTOFF']:
            Params.SPLITNORMALIZE_CUTOFF = str2num[data];
        elif strcmp[den, 'INNERCIRC_SPLITNORMALIZE_LINESWEETER']:
            temp = str2num[data];
            Params.SPLITNORMALIZE_LINESWEETER = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERCIRC_SEGMENT_LINESWEETER_MEDLINE']:
            temp = str2num[data];
            Params.INNERCIRC_SEGMENT_LINESWEETER_MEDLINE = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERCIRC_SEGMENT_AVERAGEWIDTH']:
            Params.INNERCIRC_SEGMENT_AVERAGEWIDTH = str2num[data];
        elif strcmp[den, 'INNERCIRC_FINDRETINAEXTREMA_SIGMA_GRADIENT']:
            Params.FINDRETINAEXTREMA_SIGMA_GRADIENT = str2num[data];
        elif strcmp[den, 'INNERCIRC_FINDRETINAEXTREMA_SIGMA_FZ']:
            Params.FINDRETINAEXTREMA_SIGMA_FZ = str2num[data];
            
        elif strcmp[den, 'INNERCIRC_EXTENDBLOODVESSELS_ADDWIDTH']:
            Params.INNERCIRC_EXTENDBLOODVESSELS_ADDWIDTH = str2num[data];
        elif strcmp[den, 'INNERCIRC_EXTENDBLOODVESSELS_MULTWIDTH']:
            Params.INNERCIRC_EXTENDBLOODVESSELS_MULTWIDTH = str2num[data];
        elif strcmp[den, 'INNERCIRC_EXTENDBLOODVESSELS_MULTWIDTHTHRESH']:
            Params.INNERCIRC_EXTENDBLOODVESSELS_MULTWIDTHTHRESH = str2num[data];
            
        elif strcmp[den, 'INNERCIRC_SEGMENT_MINDIST_RPE_ICL']:
            Params.INNERCIRC_SEGMENT_MINDIST_RPE_ICL = str2num[data];               
        elif strcmp[den, 'INNERCIRC_SEGMENT_MINDIST_ICL_OPL']:
            Params.INNERCIRC_SEGMENT_MINDIST_ICL_OPL = str2num[data];
        elif strcmp[den, 'INNERCIRC_SEGMENT_MINDIST_OPL_IPL']:
            Params.INNERCIRC_SEGMENT_MINDIST_OPL_IPL = str2num[data];
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPEWINDOW_ICL']:
            Params.INNERCIRC_SEGMENT_RPEWINDOW_ICL = str2num[data];
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPEWINDOW_IPL']:
            Params.INNERCIRC_SEGMENT_RPEWINDOW_IPL = str2num[data];
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPEWINDOW_OPL']:
            Params.INNERCIRC_SEGMENT_RPEWINDOW_OPL = str2num[data];
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPECONSTRANGE_ICL']:
            Params.INNERCIRC_SEGMENT_RPECONSTRANGE_ICL = str2num[data];   
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPECONSTRANGE_OPL']:
            Params.INNERCIRC_SEGMENT_RPECONSTRANGE_OPL = str2num[data];       
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPECONSTRANGE_IPL']:
            Params.INNERCIRC_SEGMENT_RPECONSTRANGE_IPL = str2num[data];    
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPESORTPART']:
            Params.INNERCIRC_SEGMENT_RPESORTPART = str2num[data];
        elif strcmp[den, 'INNERCIRC_SEGMENT_RPEDILATE']:
            Params.INNERCIRC_SEGMENT_RPEDILATE = str2num[data];       
        elif strcmp[den, 'INNERCIRC_SEGMENT_LINESWEETER_ICL']:
            temp = str2num[data];
            Params.INNERCIRC_SEGMENT_LINESWEETER_ICL = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERCIRC_SEGMENT_LINESWEETER_IPL']:
            temp = str2num[data];
            Params.INNERCIRC_SEGMENT_LINESWEETER_IPL = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERCIRC_SEGMENT_LINESWEETER_OPL']:
            temp = str2num[data];
    ...
    if strcmp[group, 'INNERLIN']:
        ...
        elif strcmp[den, 'INNERLIN_ALIGNASCANS_ADDER']:
            Params.ALIGNASCANS_ADDER = str2num[data];
        elif strcmp[den, 'INNERLIN_SEGMENT_MIRRORWIDTH']:
            Params.INNERLIN_SEGMENT_MIRRORWIDTH = str2num[data];
        elif strcmp[den, 'INNERLIN_SEGMENT_RPEDILATE']:
            Params.INNERLIN_SEGMENT_RPEDILATE = str2num[data];
        elif strcmp[den, 'INNERLIN_MEDLINE_SIGMA1']:
            Params.MEDLINE_SIGMA1 = str2num[data];
        elif strcmp[den, 'INNERLIN_MEDLINE_SIGMA2']:
            Params.MEDLINE_SIGMA2 = str2num[data];
        elif strcmp[den, 'INNERLIN_MEDLINE_MINDIST']:
            Params.MEDLINE_MINDIST = str2num[data];
        elif strcmp[den, 'INNERLIN_MEDLINE_LINESWEETER']:
            temp = str2num[data];
            Params.MEDLINE_LINESWEETER = reshape[temp, [4 7]];
            
            
        elif strcmp[den, 'INNERLIN_RANSAC_POLYNUMBER_MEDLINE']:
            Params.INNERLIN_RANSAC_POLYNUMBER_MEDLINE = str2num[data];
        elif strcmp[den, 'INNERLIN_RANSAC_POLYNUMBER_BOUNDARIES']:
            Params.INNERLIN_RANSAC_POLYNUMBER_BOUNDARIES = str2num[data];
        elif strcmp[den, 'INNERLIN_RANSAC_MAXITER']:
            Params.INNERLIN_RANSAC_MAXITER = str2num[data];
        elif strcmp[den, 'INNERLIN_RANSAC_NORM_MEDLINE']:
            Params.INNERLIN_RANSAC_NORM_MEDLINE = str2num[data];
        elif strcmp[den, 'INNERLIN_RANSAC_NORM_BOUNDARIES']:
            Params.INNERLIN_RANSAC_NORM_BOUNDARIES = str2num[data];
            
        elif strcmp[den, 'INNERLIN_MERGE_DILATE']:
            Params.INNERLIN_MERGE_DILATE = str2num[data];
        elif strcmp[den, 'INNERLIN_MERGE_BORDER']:
            Params.INNERLIN_MERGE_BORDER = str2num[data];
        elif strcmp[den, 'INNERLIN_MERGE_THRESHOLD']:
            Params.INNERLIN_MERGE_THRESHOLD = str2num[data];
        elif strcmp[den, 'INNERLIN_DISCARD_THRESHOLD']:
            
        elif strcmp[den, 'INNERLIN_SPLITNORMALIZE_CUTOFF']:
            Params.SPLITNORMALIZE_CUTOFF = str2num[data];
        elif strcmp[den, 'INNERLIN_SPLITNORMALIZE_LINESWEETER']:
            temp = str2num[data];
            Params.SPLITNORMALIZE_LINESWEETER = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERLIN_SEGMENT_LINESWEETER_MEDLINE']:
            temp = str2num[data];
            Params.INNERLIN_SEGMENT_LINESWEETER_MEDLINE = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERLIN_SEGMENT_AVERAGEWIDTH']:
            Params.INNERLIN_SEGMENT_AVERAGEWIDTH = str2num[data];
        elif strcmp[den, 'INNERLIN_FINDRETINAEXTREMA_SIGMA_GRADIENT']:
            Params.FINDRETINAEXTREMA_SIGMA_GRADIENT = str2num[data];
        elif strcmp[den, 'INNERLIN_FINDRETINAEXTREMA_SIGMA_FZ']:
            Params.FINDRETINAEXTREMA_SIGMA_FZ = str2num[data];
            
        elif strcmp[den, 'INNERLIN_EXTENDBLOODVESSELS_ADDWIDTH']:
            Params.INNERLIN_EXTENDBLOODVESSELS_ADDWIDTH = str2num[data];
        elif strcmp[den, 'INNERLIN_EXTENDBLOODVESSELS_MULTWIDTH']:
            Params.INNERLIN_EXTENDBLOODVESSELS_MULTWIDTH = str2num[data];
        elif strcmp[den, 'INNERLIN_EXTENDBLOODVESSELS_MULTWIDTHTHRESH']:
            Params.INNERLIN_EXTENDBLOODVESSELS_MULTWIDTHTHRESH = str2num[data];
            
        elif strcmp[den, 'INNERLIN_SEGMENT_MINDIST_RPE_ICL']:
            Params.INNERLIN_SEGMENT_MINDIST_RPE_ICL = str2num[data];               
        elif strcmp[den, 'INNERLIN_SEGMENT_MINDIST_ICL_OPL']:
            Params.INNERLIN_SEGMENT_MINDIST_ICL_OPL = str2num[data];
        elif strcmp[den, 'INNERLIN_SEGMENT_MINDIST_OPL_IPL']:
            Params.INNERLIN_SEGMENT_MINDIST_OPL_IPL = str2num[data];
        elif strcmp[den, 'INNERLIN_SEGMENT_RPEWINDOW_ICL']:
            Params.INNERLIN_SEGMENT_RPEWINDOW_ICL = str2num[data];
        elif strcmp[den, 'INNERLIN_SEGMENT_RPEWINDOW_IPL']:
            Params.INNERLIN_SEGMENT_RPEWINDOW_IPL = str2num[data];
        elif strcmp[den, 'INNERLIN_SEGMENT_RPEWINDOW_OPL']:
            Params.INNERLIN_SEGMENT_RPEWINDOW_OPL = str2num[data];
        elif strcmp[den, 'INNERLIN_SEGMENT_RPECONSTRANGE_ICL']:
            Params.INNERLIN_SEGMENT_RPECONSTRANGE_ICL = str2num[data];   
        elif strcmp[den, 'INNERLIN_SEGMENT_RPECONSTRANGE_OPL']:
            Params.INNERLIN_SEGMENT_RPECONSTRANGE_OPL = str2num[data];       
        elif strcmp[den, 'INNERLIN_SEGMENT_RPECONSTRANGE_IPL']:
            Params.INNERLIN_SEGMENT_RPECONSTRANGE_IPL = str2num[data];    
        elif strcmp[den, 'INNERLIN_SEGMENT_RPESORTPART']:
            Params.INNERLIN_SEGMENT_RPESORTPART = str2num[data];
        elif strcmp[den, 'INNERLIN_SEGMENT_RPEDILATE']:
            Params.INNERLIN_SEGMENT_RPEDILATE = str2num[data];       
        elif strcmp[den, 'INNERLIN_SEGMENT_LINESWEETER_ICL']:
            temp = str2num[data];
            Params.INNERLIN_SEGMENT_LINESWEETER_ICL = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERLIN_SEGMENT_LINESWEETER_IPL']:
            temp = str2num[data];
            Params.INNERLIN_SEGMENT_LINESWEETER_IPL = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERLIN_SEGMENT_LINESWEETER_OPL']:
            temp = str2num[data];
            Params.INNERLIN_SEGMENT_LINESWEETER_OPL = reshape[temp, [4 7]];
        elif strcmp[den, 'INNERLIN_VOLUME_MASK']:
            Params.INNERLIN_VOLUME_MASK = str2num[data];
        elif strcmp[den, 'INNERLIN_VOLUME_MEDFILT']:
    ...
    if strcmp[group, 'ONFLCIRC']:
        ...
        elif strcmp[den, 'ONFLCIRC_ALIGNASCANS_ADDER']:
            Params.ALIGNASCANS_ADDER = str2num[data];
        elif strcmp[den, 'ONFLCIRC_SEGMENT_MIRRORWIDTH']:
            Params.ONFLCIRC_SEGMENT_MIRRORWIDTH = str2num[data];
        elif strcmp[den, 'ONFLCIRC_SEGMENT_NOISEESTIMATE_MEDIAN']:
            Params.ONFLCIRC_SEGMENT_NOISEESTIMATE_MEDIAN = str2num[data];
        elif strcmp[den, 'ONFLCIRC_SEGMENT_DENOISEPM_SIGMAMULT']:
            Params.ONFLCIRC_SEGMENT_DENOISEPM_SIGMAMULT = str2num[data];
        elif strcmp[den, 'ONFLCIRC_DENOISEPM_TIME']:
            Params.DENOISEPM_TIME = str2num[data];
        elif strcmp[den, 'ONFLCIRC_DENOISEPM_SMOOTH']:
            Params.DENOISEPM_SMOOTH = str2num[data];
        elif strcmp[den, 'ONFLCIRC_DENOISEPM_MAXITER']:
            Params.DENOISEPM_MAXITER = str2num[data];
        elif strcmp[den, 'ONFLCIRC_FINDRETINAEXTREMA_SIGMA_GRADIENT']:
            Params.FINDRETINAEXTREMA_SIGMA_GRADIENT = str2num[data];
        elif strcmp[den, 'ONFLCIRC_FINDRETINAEXTREMA_SIGMA_FZ']:
            Params.FINDRETINAEXTREMA_SIGMA_FZ = str2num[data];
        elif strcmp[den, 'ONFLCIRC_SEGMENT_LINESWEETER_INIT_INTERPOLATE']:
            temp = str2num[data];
            Params.ONFLCIRC_SEGMENT_LINESWEETER_INIT_INTERPOLATE = reshape[temp, [4 7]];

        elif strcmp[den, 'ONFLCIRC_EXTENDBLOODVESSELS_ADDWIDTH']:
            Params.ONFLCIRC_EXTENDBLOODVESSELS_ADDWIDTH = str2num[data];
        elif strcmp[den, 'ONFLCIRC_EXTENDBLOODVESSELS_MULTWIDTH']:
            Params.ONFLCIRC_EXTENDBLOODVESSELS_MULTWIDTH = str2num[data];
        elif strcmp[den, 'ONFLCIRC_EXTENDBLOODVESSELS_MULTWIDTHTHRESH']:
            Params.ONFLCIRC_EXTENDBLOODVESSELS_MULTWIDTHTHRESH = str2num[data];

        elif strcmp[den, 'ONFLCIRC_EXTENDBLOODVESSELS_ADDWIDTH_EN']:
            Params.ONFLCIRC_EXTENDBLOODVESSELS_ADDWIDTH_EN = str2num[data];
        elif strcmp[den, 'ONFLCIRC_EXTENDBLOODVESSELS_MULTWIDTH_EN']:
            Params.ONFLCIRC_EXTENDBLOODVESSELS_MULTWIDTH_EN = str2num[data];
        elif strcmp[den, 'ONFLCIRC_EXTENDBLOODVESSELS_MULTWIDTHTHRESH_EN']:
            Params.ONFLCIRC_EXTENDBLOODVESSELS_MULTWIDTHTHRESH_EN = str2num[data];
        elif strcmp[den, 'ONFLCIRC_ENERGYSMOOTH_GRADIENTWEIGHT']:
            Params.ENERGYSMOOTH_GRADIENTWEIGHT = str2num[data];
        elif strcmp[den, 'ONFLCIRC_ENERGYSMOOTH_NEIGHBORWEIGHT']:
            Params.ENERGYSMOOTH_NEIGHBORWEIGHT = str2num[data];
        elif strcmp[den, 'ONFLCIRC_ENERGYSMOOTH_REGIONWEIGHT']:
            Params.ENERGYSMOOTH_REGIONWEIGHT = str2num[data];
        elif strcmp[den, 'ONFLCIRC_ENERGYSMOOTH_MAXITER']:
            Params.ENERGYSMOOTH_MAXITER = str2num[data];
        elif strcmp[den, 'ONFLCIRC_SEGMENT_MINDIST_IPL_ONFL']:
            Params.ONFLCIRC_SEGMENT_MINDIST_IPL_ONFL = str2num[data];
        elif strcmp[den, 'ONFLCIRC_SEGMENT_LINESWEETER_FINAL']:
            temp = str2num[data];
     ...
     if strcmp[group, 'ONFLLIN']:
        ...
        elif strcmp[den, 'ONFLLIN_ALIGNASCANS_ADDER']:
            Params.ALIGNASCANS_ADDER = str2num[data];
        elif strcmp[den, 'ONFLLIN_SEGMENT_NOISEESTIMATE_MEDIAN']:
            Params.ONFLLIN_SEGMENT_NOISEESTIMATE_MEDIAN = str2num[data];
        elif strcmp[den, 'ONFLLIN_SEGMENT_DENOISEPM_SIGMAMULT']:
            Params.ONFLLIN_SEGMENT_DENOISEPM_SIGMAMULT = str2num[data];
        elif strcmp[den, 'ONFLLIN_DENOISEPM_TIME']:
            Params.DENOISEPM_TIME = str2num[data];
        elif strcmp[den, 'ONFLLIN_DENOISEPM_SMOOTH']:
            Params.DENOISEPM_SMOOTH = str2num[data];
        elif strcmp[den, 'ONFLLIN_DENOISEPM_MAXITER']:
            Params.DENOISEPM_MAXITER = str2num[data];
        elif strcmp[den, 'ONFLLIN_FINDRETINAEXTREMA_SIGMA_GRADIENT']:
            Params.FINDRETINAEXTREMA_SIGMA_GRADIENT = str2num[data];
        elif strcmp[den, 'ONFLLIN_FINDRETINAEXTREMA_SIGMA_FZ']:
            Params.FINDRETINAEXTREMA_SIGMA_FZ = str2num[data];
        elif strcmp[den, 'ONFLLIN_SEGMENT_LINESWEETER_INIT_INTERPOLATE']:
            temp = str2num[data];
            Params.ONFLLIN_SEGMENT_LINESWEETER_INIT_INTERPOLATE = reshape[temp, [4 7]];
        elif strcmp[den, 'ONFLLIN_SEGMENT_LINESWEETER_INIT_SMOOTH']:
            temp = str2num[data];
            Params.ONFLLIN_SEGMENT_LINESWEETER_INIT_SMOOTH = reshape[temp, [4 7]];

        elif strcmp[den, 'ONFLLIN_EXTENDBLOODVESSELS_ADDWIDTH_ALL']:
            Params.ONFLLIN_EXTENDBLOODVESSELS_ADDWIDTH_ALL = str2num[data];
        elif strcmp[den, 'ONFLLIN_EXTENDBLOODVESSELS_MULTWIDTH_ALL']:
            Params.ONFLLIN_EXTENDBLOODVESSELS_MULTWIDTH_ALL = str2num[data];
        elif strcmp[den, 'ONFLLIN_EXTENDBLOODVESSELS_MULTWIDTHTHRESH_ALL']:
            Params.ONFLLIN_EXTENDBLOODVESSELS_MULTWIDTHTHRESH_ALL = str2num[data];

        elif strcmp[den, 'ONFLLIN_EXTENDBLOODVESSELS_ADDWIDTH_EN']:
            Params.ONFLLIN_EXTENDBLOODVESSELS_ADDWIDTH_EN = str2num[data];
        elif strcmp[den, 'ONFLLIN_EXTENDBLOODVESSELS_MULTWIDTH_EN']:
            Params.ONFLLIN_EXTENDBLOODVESSELS_MULTWIDTH_EN = str2num[data];
        elif strcmp[den, 'ONFLLIN_EXTENDBLOODVESSELS_MULTWIDTHTHRESH_EN']:
            Params.ONFLLIN_EXTENDBLOODVESSELS_MULTWIDTHTHRESH_EN = str2num[data];        
            
        elif strcmp[den, 'ONFLLIN_RANSAC_POLYNUMBER']:
            Params.ONFLLIN_RANSAC_POLYNUMBER = str2num[data];    
        elif strcmp[den, 'ONFLLIN_RANSAC_MAXITER']:
            Params.ONFLLIN_RANSAC_MAXITER = str2num[data];
        elif strcmp[den, 'ONFLLIN_RANSAC_NORM']:
            Params.ONFLLIN_RANSAC_NORM = str2num[data];
        elif strcmp[den, 'ONFLLIN_MERGE_DILATE']:
            Params.ONFLLIN_MERGE_DILATE = str2num[data];
        elif strcmp[den, 'ONFLLIN_MERGE_BORDER']:
            Params.ONFLLIN_MERGE_BORDER = str2num[data];
        elif strcmp[den, 'ONFLLIN_MERGE_THRESHOLD']:
            Params.ONFLLIN_MERGE_THRESHOLD = str2num[data];
            
        elif strcmp[den, 'ONFLLIN_ENERGYSMOOTH_GRADIENTWEIGHT']:
            Params.ENERGYSMOOTH_GRADIENTWEIGHT = str2num[data];
        elif strcmp[den, 'ONFLLIN_ENERGYSMOOTH_NEIGHBORWEIGHT']:
            Params.ENERGYSMOOTH_NEIGHBORWEIGHT = str2num[data];
        elif strcmp[den, 'ONFLLIN_ENERGYSMOOTH_REGIONWEIGHT']:
            Params.ENERGYSMOOTH_REGIONWEIGHT = str2num[data];
        elif strcmp[den, 'ONFLLIN_ENERGYSMOOTH_MAXITER']:
            Params.ENERGYSMOOTH_MAXITER = str2num[data];
        elif strcmp[den, 'ONFLLIN_SEGMENT_MINDIST_IPL_ONFL']:
            Params.ONFLLIN_SEGMENT_MINDIST_IPL_ONFL = str2num[data];
        elif strcmp[den, 'ONFLLIN_SEGMENT_LINESWEETER_FINAL']:
            temp = str2num[data];
            Params.ONFLLIN_SEGMENT_LINESWEETER_FINAL = reshape[temp, [4 7]];
        elif strcmp[den, 'ONFLLIN_VOLUME_MASK']:
            Params.ONFLLIN_VOLUME_MASK = str2num[data];
        elif strcmp[den, 'ONFLLIN_VOLUME_MEDFILT']:
