def segmentINFLLin[bscan, PARAMS, rpe, medline]:
...
# approach. This was also not pushed further. You may comment this out if # you'll only are interested in volume segmentation.:
