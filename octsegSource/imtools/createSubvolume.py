def createSubvolume[DataDescriptors, Data, range, align, blacken]:
...
if numel[range] == 2  :
    ...
    if blacken:
        ...
        for i in 1:size[Data.bScans, 2]:
            for j in 1:size[Data.bScans, 3]:
                Data.bScans[1:rangeTemp(j,i,1],i,j) = 0;
                Data.bScans[rangeTemp(j,i,2]:,i,j) = 0;
    ...
    if align == 0:
        ...
        for i in 1:size[Data.bScans, 2]:
            for j in 1:size[Data.bScans, 3]:
                actDist = dist[j,i];               
                subBScans[-actDist:,i,j] = Data.bScans[range(j,i,1]:range[j,i,2],i,j);
