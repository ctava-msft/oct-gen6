def readOctMetaMergedVolume[DataDescriptors, tags]:
...
# TAGS: Cell structure, created by getMetaTag if type 'both...T is used:
#
...
for i in 1:DataDescriptors.Header.NumBScans:
