...
# CSVSAVEBSCANS GUI wrapper for the csv export functions for
# linear/circular B-Scans (volumes have a different GUI wrapper)
# 
...
# csv export functions csvSaveRowsDirect or csvSaveColumnsDirectBScans
# respectively.
#
...
#--------------------------------------------------------------------------
    ...
    function hSave_Callback[hObject, eventdata]
        ...
        if numel[dataTag] == 0 andand get[hDataPop, 'Value'] != 2:
