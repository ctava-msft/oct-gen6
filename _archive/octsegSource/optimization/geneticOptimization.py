def geneticOptimization[fixedLayer, layers, segments, genValues, Params, costFunction, dist, gradient, factor]:
...
disp[['Starting genetic optimization with ' num2str(Params.maxIter] ' iterations.T]);
...
while iter < Params.maxIter:
    ...
    for couple in 1:Params.numCouples:
        #         for child in 1:Params.numChildren:
    ...
    for child in 1:Params.numCouples * Params.numChildren:
