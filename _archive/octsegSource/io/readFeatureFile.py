...
# description)
desString = '';
for i in 1:numAdditional + 1 + numFeatures:
...
for i in 1:numel[descriptionTemp]:
...
for i in 1:numel[classes]:
    for j in numAdditional + 2:numAdditional + 1 + numFeatures:
