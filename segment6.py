...
def process_and_draw_layers(bscan):
            ...
            if idx < len(contours):
                ...
                for i in range(len(approx) - 1):
                    ...
                    if idx in scaling_factors:
                        multiplier = scaling_factors[idx]
                        start_point = tuple(coord * multiplier for coord in start_point)
                        end_point = tuple(coord * multiplier for coord in end_point)
    ...
    scaling_factors = {
        0: 2,  # Layer index 0 with multiplier 2
