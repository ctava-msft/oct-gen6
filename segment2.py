...
def process_and_draw_layers(image_path):
    ...
    image_path = image_path.replace(".bmp", f"_{random_suffix}.bmp")
    image_path = image_path.replace(".png", f"_{random_suffix}.png")
    image_path = image_path.replace(".jpg", f"_{random_suffix}.jpg")
